...
const Profile = ({ doctorData }) => {
  ...
  const handleFileInputChange = async (event) => {
    ...
    /* console.log(data); */ // It show info about image upload to cloudinary platform.
  ...
  const addTimeSlot = (e) => {
    ...
    setFormData((prevFormData) => ({
      ...
      timeSlots: [
        ...
        { day: "", startingTime: "", endingTime: "" }, // Default empty values
      ],
    }));
  };
  ...
  const handleTimeSlotChange = (event, index) => {
    ...
    setFormData((prevFormData) => {
      ...
      updateItems[index][name] = value; // Update the specific time field
      return {
        ...prevFormData,
        timeSlots: updateItems,
      };
    });
  };
  ...
  const deleteTimeSlot = (e, index) => {
    e.preventDefault();
    setFormData((prevFormData) => {
      const updateItems = prevFormData.timeSlots.filter((_, i) => i !== index);
      return {
        ...prevFormData,
        timeSlots: updateItems,
      };
      ...
      <form>
        ...
        <div className="mb-5">
          ...
          <input
            ...
            readOnly
            aria-readonly
            disabled={true} // Wrong way disable="true" .
          />
        </div>
        <div className="mb-5">
        ...
        <div className="mb-5">
          ...
          {formData.timeSlots?.map((item, index) => (
            <div key={index}>
              <div>
                <div className="grid grid-cols-2 md:grid-cols-4 md-[30px] gap-5">
                  <div>
