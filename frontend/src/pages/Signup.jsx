...
const Signup = () => {
  ...
  const handleFileInputChange = async (event) => {
    ...
    /* console.log(data); */ // data is visible in inspect/network/preview section in browser.
    setPreviewURL(data.url);
    setSelectedFile(data.url);
    setFormData({ ...formData, photo: data.url });

    // above later we will us cloudinary to upload images
  ...
  const submitHandler = async (event) => {
    ...
    /*  console.log(formData); */ // Add this line to see the data before sending
          ...
          <div className="rounded-l-lg lg:pl-16 py-10">
            ...
            <form onSubmit={submitHandler}>
              ...
              <div className="mt-7">
                ...
                >
                  {loading ? (
                    <HashLoader size={32} color="#FFFFFF" />
                  ) : (
                    "Sign Up"
                  )}
                </button>
